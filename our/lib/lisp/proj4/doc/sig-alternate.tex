...
\begin{centering}
\begin{verbatim}
Replace each class symbol with a 
utility score: True = 1, False = 0.
Sort instances by that score and 
divide them using N=20\%-chops.
Label all the rows in bin=1 (20\%) 
"best" and the remaining (80\%) "rest".

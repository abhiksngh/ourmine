...
public class Canopy {
    ...
    private ArrayList<ArrayList<Cluster>> _finalClusterGroups = new ArrayList<ArrayList<Cluster>>();
    ...
    public void clusterCanopiesViaKmeans(String k)
    {
        ...
        for(CanopyStructure canopy : _canopies)
        {
            ...
            //add new list of these clusters here
            getFinalClusterGroups().add(new ArrayList<Cluster>());

            for(Cluster cluster : kmeans.getClusters())
            {
                getFinalClusterGroups().get(getFinalClusterGroups().size()-1).add(cluster);
            }
    ...
    /**
     * @return the _finalClusterGroups
     */
    public ArrayList<ArrayList<Cluster>> getFinalClusterGroups() {
        return _finalClusterGroups;
    }

...
plot	"$file1" using 1:2 title 'MultiPipes' with points 1 2,\
...
plot	"$file1" using 1:3 title 'MultiPipes' with points 1 2,\
	"$file6" using 1:3 title 'a = .10' with points 13 4,\
	"$file7" using 1:3 title 'a = .25' with points 9 4,\
	"$file8" using 1:3 title 'a = .50' with points 5 4

...
'(49 female no yes yes yes yes yes yes no yes no no 0.6 85 48 3.7 ? no LIVE)
...
'(37 female yes no yes no no yes no no yes no no 0.6 67 28 4.2 ? no DIE)
'(23 female yes no yes yes yes yes no yes no no no 1.3 194 150 4.1 90 no LIVE)
'(20 male no no yes yes yes no yes yes yes no no 2.3 150 68 3.9 ? no LIVE)
...
'(23 female yes no no no no ? ? ? ? ? ? 4.6 56 16 4.6 ? no LIVE)
...
'(28 female yes no yes yes no yes no no no no no 0.7 74 110 4.4 ? no LIVE)
'(37 female no no no no no yes yes no yes no no 0.6 80 80 3.8 ? no LIVE)
...
'(39 female no no no no no yes no no no no no 0.9 85 60 4 ? no LIVE)
...
'(37 female no no yes yes yes yes no no no no no 0.8 92 59 ? ? no LIVE)
...
'(27 female yes no no no no yes no no no no no 0.8 ? 38 4.2 ? no LIVE)
'(56 female no no no no no yes no no no no no 0.7 62 33 3 ? no LIVE)
'(57 female yes no yes yes yes yes no no yes yes no 4.1 ? 48 2.6 73 no DIE)
'(39 female yes no yes no no yes no no no no no 1 34 15 4 54 no LIVE)
'(44 female no no yes yes no yes no no no no no 1.6 68 68 3.7 ? no LIVE)
'(24 female yes no no no no yes no no no no no 0.8 82 39 4.3 ? no LIVE)
'(34 female no no yes yes no no yes no yes no no 2.8 127 182 ? ? no DIE)
'(51 female yes no yes yes yes ? ? ? ? ? ? 0.9 76 271 4.4 ? no LIVE)
'(36 female no no yes yes yes yes yes no no no no 1 ? 45 4 57 no LIVE)
'(50 female yes no no no no yes no no no no no 1.5 100 100 5.3 ? no LIVE)
'(32 female no yes yes yes no yes no no no no no 1 55 45 4.1 56 no LIVE)
'(58 female yes no yes no no no yes yes yes no no 2 167 242 3.3 ? no DIE)
...
'(28 female yes no no no no yes no no no no no 0.7 85 31 4.9 ? no LIVE)
'(23 female yes no yes yes yes yes no no no no no 0.8 ? 14 4.8 ? no LIVE)
...
'(44 female no no yes yes no yes no yes no no yes 0.9 135 55 ? 41 yes DIE)
'(30 female yes no yes yes yes yes yes no yes yes yes 2.5 165 64 2.8 ? yes DIE)
'(38 female no no yes yes yes yes yes no yes yes yes 1.2 118 16 2.8 ? yes DIE)
...
'(42 female no no yes yes yes yes no yes yes no yes 4.6 ? 55 3.3 ? yes DIE)
'(33 female yes no no no no ? ? no no no no 1 ? 60 4 ? yes LIVE)
'(52 female no no no no no yes no no no no no 1.5 ? 69 2.9 ? yes LIVE)
...
'(22 female yes no no no no yes no no no no no 0.7 ? 24 ? ? yes LIVE)
...
'(25 female yes no no no no yes no no no no no 0.6 ? 34 6.4 ? yes LIVE)
'(35 female no no yes no no ? ? yes yes yes no 1.5 138 58 2.6 ? yes DIE)
'(45 female no no yes yes yes yes no no no no no 2.3 ? 648 ? ? yes LIVE)
...
'(7 female yes no no no no yes yes yes no no no 0.7 256 25 4.2 ? yes LIVE)
...
'(45 female no no yes no no yes yes yes no no no 1.2 81 65 3 ? no LIVE)
'(36 female no no no no no yes no no no no no 1.1 141 75 3.3 ? yes LIVE)
'(69 male yes no yes no no yes no no no no no 3.2 119 136 ? ? yes LIVE)
'(24 female no no yes no no yes no no no no no 1 ? 34 4.1 ? yes LIVE)
'(50 female yes no no no no yes no no no no no 1 139 81 3.9 62 yes LIVE)
'(61 female no no yes yes no ? ? no yes no no ? ? ? ? ? yes DIE)
'(54 female yes no yes no no no yes no no no no 3.2 85 28 3.8 ? yes LIVE)
'(56 female no no yes yes yes no yes no yes no no 2.9 90 153 4 ? yes DIE)
...
'(37 female no no yes no no yes no no yes no no 0.9 ? 231 4.3 ? yes LIVE)
...
'(31 female no no yes yes yes yes no yes no no no 8 ? 101 2.2 ? yes DIE)
'(48 female yes no yes yes yes yes yes no yes no no 2 158 278 3.8 ? yes LIVE)
...
'(51 female yes no no no no no yes no yes no no 0.8 ? 33 4.5 ? yes LIVE)
...
'(36 female no no yes yes yes no yes no yes no yes 1.7 295 60 2.7 ? yes LIVE)
'(54 female no no yes yes no ? ? yes no yes no 3.9 120 28 3.5 43 yes DIE)
...
'(45 female yes no yes yes yes yes no no yes yes no 1.9 ? 114 2.4 ? yes DIE)
'(31 female no no yes no no yes no no no no no 1.2 75 173 4.2 54 yes LIVE)
'(41 female yes no yes no no yes yes yes yes no yes 4.2 65 120 3.4 ? yes DIE)
'(70 female no no yes yes yes ? ? ? ? ? ? 1.7 109 528 2.8 35 yes DIE)
'(20 female no no no no no yes ? no no no no 0.9 89 152 4 ? yes LIVE)
'(36 female yes no no no no yes no no no no no 0.6 120 30 4 ? yes LIVE)
'(46 female yes no yes yes yes yes no no yes yes yes 7.6 ? 242 3.3 50 yes DIE)
'(44 female yes no yes no no yes yes no no no no 0.9 126 142 4.3 ? yes LIVE)
'(61 female no no yes yes no no yes no yes no no 0.8 75 20 4.1 ? yes LIVE)

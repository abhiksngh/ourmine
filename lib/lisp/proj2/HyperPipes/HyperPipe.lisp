         ...
         (if (not (equal currentExperience '?))
             (if (numberp currentExperience)
                 (progn
                   ...
                   (incf (NumericBound-sum currentBound) currentExperience)
                   (incf (NumericBound-sumSquares currentBound) (* currentExperience currentExperience))
                   ...
                   ;(format t "~a ~a ~a" currentExperience (NumericBound-mean currentBound) (NumericBound-currentSD currentBound))
